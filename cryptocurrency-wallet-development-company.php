...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo $siteurl; ?>assets/css/cryptocurrency-wallet-development-company.css" as="style" media="all" />
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $siteurl; ?>assets/css/media.css" fetchpriority="low"
        as="style" media="all" />
    <link rel="stylesheet" type="text/css" href="<?php echo $siteurl; ?>assetsindex/css/fontawesome/css/all.min.css"
        as="font" fetchpriority="low">
    <link rel="stylesheet" type="text/css" href="<?php echo $siteurl; ?>css/contact.css" fetchpriority="low" as="style"
        media="all">
    <link rel="stylesheet" type="text/css" href="<?php echo $siteurl; ?>css/form.css" fetchpriority="low" as="style"
        media="all">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $siteurl; ?>assets/css/owl.theme.min.css"
        fetchpriority="low">
...
<body class="crypto-wallet-page">
    ...
    <script src="<?php echo $siteurl; ?>assets/js/aos.js" async></script>
