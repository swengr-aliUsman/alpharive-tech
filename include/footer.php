...
<section class="footer-sctn">
    <div class="contain-width">
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                ...
                <img src="<?php echo $siteurl; ?>assets/images/logo.webp" fetchpriority="low" loading="lazy" alt="logo" class="img-fluid opris-logo" width="132" height="47"/>
                </a>
               
            </div>
               <p class="footer-cnt">Opris is your go-to for top-tier digital transformation solutions, focused on delivering exceptional services that drive client success. Your triumph is our ultimate goal.</p>
           ...
           <div class="followus">
                <p>Follow Us</p>
                    ...
                    <ul>
                        <li><a href="https://www.linkedin.com/company/opris-exchange-global/" target="_blank" aria-label="social-btn">
                          <i class="fa-brands fa-linkedin-in"></i>
                        </a></li>
                        <!--<li><a href="" target="_blank" aria-label="social-btn">-->
                        <!--    <img src="<?php echo $siteurl; ?>assets/images/social-icon-1.svg" alt="icon" loading="lazy" width="33" height="33"/>-->
                        <!--</a></li>-->
                        <li><a href="https://www.facebook.com/oprisglobalexchange" target="_blank" aria-label="social-btn">
                           <i class="fa-brands fa-facebook-f"></i>
                        </a></li>
                        <li><a href="https://www.instagram.com/opris.exchange/" target="_blank" aria-label="social-btn">
                            <i class="fa-brands fa-instagram"></i>
                        </a></li>
                        <li><a href="https://www.youtube.com/@oprisexchange" target="_blank" aria-label="social-btn">
                            <i class="fa-brands fa-youtube"></i>
                        </a></li>
                        <li><a href="https://www.pinterest.com/oprisexchange/" target="_blank" aria-label="social-btn">
 ...
 <div class="row">
            ...
            <div class="col-sm-12 col-md-5 col-lg-5 col-xl-5">
                <p>Services</p>
                <ul>
                    <li><a href="<?php echo $siteurl; ?>cryptocurrency-exchange-development/">Crypto exchange</a></li>
                     <li><a href="<?php echo $siteurl; ?>crypto-trading-bot-development/">Trading Bot</a></li>
                    <!--<li><a href="<?php echo $siteurl; ?>cryptocurrency-wallet-development/"> Wallet</a></li>-->
                    <!--<li><a href="<?php echo $siteurl; ?>"> Token</a></li>-->
                    <!--<li><a href="<?php echo $siteurl; ?>">Web3</a></li>-->
                    <!--<li><a href="<?php echo $siteurl; ?>">Launchpad </a></li>-->
                    <li><a href="<?php echo $siteurl; ?>blockchain-development-company/">Blockchain </a></li>
                    <!--<li><a href="<?php echo $siteurl; ?>blockchain-game-development/">Gaming </a></li>-->
                </ul>
            </div>
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                ...
                <ul>
                    ...
                    <!--<li><a href="<?php echo $siteurl; ?>bitpay-clone-script"> Bitpay clone script  </a></li>-->
                </ul>
            </div>
           </div> 
           </div>
        ...
        <div class="copy-right-sctn">
            ...
            <div class="powdred">
                <span>© Opris Tech Pvt Ltd, 2024</span>
            </div>
            </div>
        </div>
    </div>
...
<div class="assistance-bx" id="appo-container">
    ...
    <div class="inner-pop-up-home sm">
        ...
        <img src="<?php echo $siteurl; ?>Images/popup-avatar-logo.webp" alt="Opris-Logo" loading="lazy">
...
<ul class="social-contact-list">
    ...
    <li><a target="_blank" href="skype:live:.cid.b4d98d670fe822a2?chat"><img
                src="<?php echo $siteurl; ?>Images/skype.webp"
                alt="cryptocurrency-exchange-development-services" loading="lazy" width="100" height="100"></a>
            </li>

    <li><a target="_blank" href="https://t.me/+919994248706"><img
                src="<?php echo $siteurl; ?>Images/telegram.webp"
    ...
    <li><a target="_blank"
            href="https://api.whatsapp.com/send/?phone=%2B919994248706&text&type=phone_number&app_absent=0"><img
                src="<?php echo $siteurl; ?>Images/whatsapp.webp"
                alt="cryptocurrency-exchange-development-services" loading="lazy" width="100" height="100"></a></li>
 ...
 <script src="<?php echo $siteurl; ?>assets/js/3.6.0/jquery.min.js"></script>
...
<script>
  $(document).ready(function() {
    $('li.relative').click(function() {
      $('li.relative').removeClass('active');
      $(this).addClass('active');
      if ($(this).hasClass('active')) {
        $('li.relative .our_offerings_nav').removeClass('active');
        $('li.relative .our_offerings_detail').removeClass('active');
