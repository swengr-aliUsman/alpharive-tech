...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $siteurl; ?>css/paxful-clone-script.css?v=1.2" fetchpriority="high">
...
<!-- <link rel="stylesheet" type="text/css" href="<?php echo $siteurl; ?>css/niceCountryInput.css" fetchpriority="low"> -->  
    ...
    <link rel="canonical" href="<?php echo $siteurl; ?>paxful-clone-script/" />
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="banner-right pax">
                        <img src="<?php echo $siteurl; ?>Images/paxful-clone-script-development-software.png"
                            alt="paxful-clone-script-development-software" fetchpriority="high">
                    </div>
                </div>
            </div>
        </div>
